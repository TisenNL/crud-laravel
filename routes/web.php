...
Route::post('/cadastrar-canditado', function(Request $informacoes){
    Candidato::create([
...
Route::get('/mostrar-candidato/{id_do_candodato}', function ($id_do_candidato){
...
Route::get('/editar-candidato/{id_do_candodato}', function ($id_do_candidato){
    $candidato = Candidato::findOrFail($id_do_candidato);
